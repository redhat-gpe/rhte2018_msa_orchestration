...
In this section of the lab, we leverage Prometheus SQL to measure the rate of `Ride` entities per status, as well as the rate of process instances created.
